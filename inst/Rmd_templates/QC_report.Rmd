...
# Data load
## site_md
site_md <- dl_metadata(params$md_file, 'Data', parent_logger = logger_name)[c(1:11),]

## plant_md
plant_md <- dl_metadata(params$md_file, 'Data', si_code_loc = site_md,
                          parent_logger = logger_name)[c(12:19),]

## psi_data
psi_data <- dl_metadata(params$psi_file, 'Data', si_code_loc = site_md,
                     parent_logger = logger_name)[c(20:29),]

## stand_md
questionnaire_md <- dl_metadata(params$md_file, 'Questionnaire', si_code_loc = site_md,
